		    ...
		    if($result)
		    {
			    ...
			    foreach ($result as $key => $value) {
			     	echo '<tr>
									...
									<td>'.$value['email'].'</td>
									<td><a href="add_users.php?username='.$value["username"].'&t='.$token.'"><button class="btn btn-success">Accept</button></a></td>
									<td><a href="remove_users.php?username='.$value["username"].'&t='.$token.'"><button class="btn btn-success">Reject</button></a></td>';
