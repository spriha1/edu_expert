<?php 
	...
	if(isset($_SESSION["username"]))
	{
		...
		if (isset($_POST['user_type'])) {
		    $query = "SELECT firstname, lastname, email, username, block_status FROM users where user_reg_status = 1 AND user_type_id = (SELECT id FROM user_types where user_type = '".$_POST['user_type']."')";
